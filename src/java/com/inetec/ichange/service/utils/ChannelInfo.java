...
public class ChannelInfo {
    ...
    public void set(Channel channel, String password, String privateKeypath) {
        ...
        if (channel.getPort() == null || channel.getPort() == "") {
            m_url = initUrl(channel.getIpAddress(), m_port + "");
        } else {
            m_url = initUrl(channel.getIpAddress(), channel.getPort());
