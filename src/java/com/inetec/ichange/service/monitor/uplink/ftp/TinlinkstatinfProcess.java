...
import com.inetec.ichange.service.monitor.uplink.infobean.TInlinkstatinfBean;
 ...
 */
public class TinlinkstatinfProcess {
    private static Logger logger = Logger.getLogger(TinlinkstatinfProcess.class);
    ...
    public void process(FtpClient ftpclient) {
        ...
        TInlinkstatinfBean tplatbean = new TInlinkstatinfBean();
...
ftpclient.upfile(tspz.getIp(), port, tspz.getUsername(), tspz.getPassword(),
     UpFileUtils.Str_FtpDir, filename2 + ".finished");*/
        logger.info("级联上报--Tinlinkstatinf 项上报成功! ");
