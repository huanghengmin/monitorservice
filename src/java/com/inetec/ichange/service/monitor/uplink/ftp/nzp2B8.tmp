...
import com.inetec.ichange.service.monitor.uplink.infobean.TPlatbizinfBean;
 ...
 */
public class TPlatbizinfProcess {
    private static Logger logger = Logger.getLogger(TPlatbizinfProcess.class);
    ...
    public void process(UpFtpClient ftpclient) {
        ...
        TPlatbizinfBean tplatbean = new TPlatbizinfBean();
        ...
        logger.info("级联上报--TPlatbizinf 项上报成功! ");
