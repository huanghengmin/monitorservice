 ...
 */
public class ServiceMonitorRevokeCert implements IServiceCommondProcess {
    /**
     * @param input
    ...
    public DataAttributes process(String fileName, DataAttributes dataAttributes) throws Ex {
        ...
        String printScreen = dataAttributes.getProperty(ServiceUtil.Str_Monitor_RevokeCert, "");
